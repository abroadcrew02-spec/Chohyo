...
// issue #71 (a')・設計レビュー差し戻し1: 08 §2.4.3 の10コードに完全一致させる。
 ...
 *  （issue P-H1・レビュー7巡目 Wave 0・批判役の指摘採用分）。
 *
...
/// FR-1.9・デザインレビュー S-5「事故防止の最後の砦」）から「N 欄を出力しません」の
...
/** 「読み取りを開始」が無効の理由（user_advocate の初見ユーザー
