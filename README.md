...
- 出力の列構成はテンプレート定義から導出する（現行の chouhyo-v1 は 220列＝管理6＋本人14＋家族欄60＋明細140。本人14には郵便番号1/2 を含む）。.xlsx が目検と提出の正、.csv はシステム取り込み用。**エディタで欄を足せば列も増える**ため、.csv を取り込むシステムがある場合は列構成の変更を先方と合わせてから保存する
